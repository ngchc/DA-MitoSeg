...
# restore weights
weight = './models/model-c-all.pth'
# weight = './models/model-c-20.pth'
# weight = './models/model-c-40.pth'
# weight = './models/model-c-60.pth'
# weight = './models/model-c-80.pth'
